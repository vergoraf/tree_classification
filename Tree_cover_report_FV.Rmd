...
#### Elevation
\hfill\break 
Through a visual analysis it can be defined that the tree species have different distribution according to the elevation (figure \@ref(fig:qboxplotelev)). Where it can be found similar distribution is with the Krummholz and Ponderosa Pine species. Therefore, is relevant to include other variables. 

```{r qboxplotelev, echo=FALSE, fig.width=5, fig.height=3,message=FALSE,fig.cap='Treemap plot Wilderness area'} 
train_tc %>% 
...
#### Slope
\hfill\break 
At difference with elevation variable, the species with the slope variable (figure \@ref(fig:qboxplotslope)),are more similar in their distribution, notwithstanding, is relevant that Krummholz and Ponderosa Pine species are different in this case, so this can help us to classify them better.

```{r qboxplotslope, echo=FALSE, fig.width=5, fig.height=2.5,message=FALSE,fig.cap='Treemap plot Wilderness area'} 
train_tc %>% 
